...
public:
	...
	static bool IsInputEnabled()  { return bInputEnabled; }

	/** Enable or disable ImGui input. */
	static void SetInputEnabled(bool bEnabled) { bInputEnabled = bEnabled; }

	/** Toggle ImGui input. */
	static void ToggleInput() { SetInputEnabled(!IsInputEnabled()); }
	...
	static bool IsMouseInputShared() { return bMouseInputShared; }

	/** Set whether mouse input should be shared with game. */
	static void SetMouseInputShared(bool bShared) { bMouseInputShared = bShared; }
...
private:
	...
	static bool bInputEnabled;
	static bool bMouseInputShared;
...
bool FImGuiModuleProperties::bInputEnabled = false;
bool FImGuiModuleProperties::bMouseInputShared = false;